...
public class MobSpawner {
	...
	public static enum CustomMobLevel {
		SNOWY(CivColor.LightGray+"Snowy"), // Iron, Diamond
		COLD(CivColor.LightGreen+"Cold"), // Gold, Redstone
		LUSH(CivColor.Yellow+"Lush"), // Iron, Redstone
		WARM(CivColor.Rose+"Warm"), // Gold, Diamond
		WATER(CivColor.LightBlue+"Water"), // Coal, Redstone, Lapis, Emerald
		
		UNUSED(CivColor.BlackBold+" UNUSED ");
