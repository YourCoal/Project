...
public class PickRandomBlockCoins extends RandomEventComponent {
		...
		class SyncTask implements Runnable {
			...
			public void run() {
				try {
					...
					sendMessage("(Note that the cache will be in a STONE block. This includes andesite, diorite, and granite.)");
