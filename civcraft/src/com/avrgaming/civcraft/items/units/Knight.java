...
public class Knight extends UnitMaterial {
	...
	public static void spawn(Inventory inv, Town town) throws CivException {
		ItemStack is = LoreMaterial.spawn(Unit.KNIGHT_UNIT);
		...
		attrs.addLore(CivColor.LightGray+"+20% Attack with Bow");
		attrs.addLore(CivColor.LightGray+"+45% Defense on Armor");
		is = attrs.getStack();
		
		if (!Unit.addItemNoStack(inv, is)) {
			throw new CivException("Cannot make "+Unit.KNIGHT_UNIT.getUnit().name+". Barracks chest is full! Make Room!");
		}
	}
