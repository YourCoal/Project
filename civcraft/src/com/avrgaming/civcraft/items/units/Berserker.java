...
public class Berserker extends UnitMaterial {
	...
	public static void spawn(Inventory inv, Town town) throws CivException {
		ItemStack is = LoreMaterial.spawn(Unit.BERSERKER_UNIT);
		...
		if (!Unit.addItemNoStack(inv, is)) {
			throw new CivException("Cannot make "+Unit.BERSERKER_UNIT.getUnit().name+". Barracks chest is full! Make Room!");
		}
	}
