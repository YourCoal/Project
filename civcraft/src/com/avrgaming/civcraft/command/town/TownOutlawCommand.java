...
//		commands.put("addallciv", "[civ] - Adds entire civilization to the outlaw list.");
//		commands.put("removeallciv", "[civ] - Removes entire civilization from the outlaw list.");
	...
	public void removeallciv_cmd() throws CivException {
		...
		CivMessage.sendSuccess(sender, "Removed civ "+args[1]+" from being an outlaw.");
		town.save();
	}
	...
	public void removealltown_cmd() throws CivException {
		...
		CivMessage.sendSuccess(sender, "Removed town "+args[1]+" from being an outlaw.");
		town.save();
	}
