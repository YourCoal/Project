...
public class ReportCommand extends CommandBase {
	...
	public void player_cmd() throws CivException {
		...
		CivMessage.send(sender, CivColor.Yellow+ChatColor.BOLD+"Please select one of the following categories:");
		CivMessage.send(sender, CivColor.LightGreen+ChatColor.BOLD+ReportManager.getReportTypes());
		CivMessage.send(sender, " ");
